...
export default class Edit_Inventory_Item_Screen extends React.Component {
    ...
    UpdateItem = () => {
        ...
        db.transaction(function (txn) {
            ...
            txn.executeSql('UPDATE InventoryItems set ItemName = ?, ItemDescription = ?, ItemCode = ?, ItemBarcode = ?, UnitID = ?, ItemCategoryID = ?, SupplierID = ?,  PerUnitCostPrice = ?, PerUnitSellprice = ?, CurrentStock = ?, AsOFDate  = ? where ItemID = ?',
                [itemName, itemDescription, itemCode, itemBarCode, selectedUnit, selectedItemCategory, selectedSupplier, perUnitBuyingCost, perUnitSellingCost, itemCurrentstock, assOfDate, itemID],
                (txn, results) => {
                    ...
                    <View style={{ marginBottom: 50 }}>
                        ...
                        {this.state.isVisibleView2 ?
                            <View style={styles.view1}>
                                ...
                                <Text style={styles.textstyle}>Current Stock = {this.state.itemCurrentstock}</Text>
                                ...
                                <Text style={styles.textstyle}>Minimum Stock = {this.state.itemMinimumStock}</Text>
